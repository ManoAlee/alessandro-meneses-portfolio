...
This is a personal portfolio project. The latest version on the `main` branch is the only supported version.
...
- The deployed version at the official domain.

It does not apply to:

- Third-party libraries (please report issues to the respective maintainers).
- Infrastructure providers (Vercel, GitHub Pages, etc.).
