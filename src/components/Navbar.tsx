        ...
        <>
            ...
            `}>
                    ...
                    <button
                        ...
                        className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden hover:scale-110 transition-transform shadow-lg"
                    >
                        <img src="/logo.png" alt="Logo AM" className="w-full h-full object-cover" />
                    </button>
