...
import { Mail, Linkedin, Github, Send, Terminal, Copy, Check } from "lucide-react";
                                    ...
                                    <div className="grid gap-4">
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <div className="text-white font-mono text-sm md:text-base break-all">{userData.profile.email}</div>
                                            </div>
                                        </a>

                                        <a
                                            href={`https://wa.me/55${userData.profile.phone.replace(/\D/g, '')}`}
                                            target="_blank"
                                            rel="noreferrer"
                                            className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-green-500/10 hover:border-green-500/50 transition-all group"
                                        >
                                            <div className="p-3 rounded-full bg-green-500/10 text-green-500 group-hover:bg-green-500 group-hover:text-black transition-colors">
                                                <Send size={24} />
                                            </div>
                                            <div>
                                                <div className="text-xs text-slate-500 uppercase tracking-wider">Phone / WhatsApp</div>
                                                <div className="text-white font-mono text-sm md:text-base">{userData.profile.phone}</div>
                                            </div>
                                        </a>

                                        <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-purple-500/10 hover:border-purple-500/50 transition-all group cursor-default">
                                            ...
                                            <div>
                                                <div className="text-xs text-slate-500 uppercase tracking-wider">Base Location</div>
                                                <div className="text-white font-mono text-sm md:text-base">Boituva - SP</div>
                                            </div>
                                        </div>
                                    </div>
